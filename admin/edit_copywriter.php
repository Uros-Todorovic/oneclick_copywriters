  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                    <h1 class="page-header mt-3">Edit Copywriter</h1>
                        <form action="" method="post" enctype="multipart/form-data" class="mt-5" >
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" value="<?php echo $copywriter->name; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="description">Description</label>
                                    <input type="text" name="description" class="form-control" value="<?php echo $copywriter->description; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="price">Price</label>
                                    <input type="number" name="price" class="form-control" value="<?php echo $copywriter->price; ?>">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <img src="<?php echo $copywriter->image_path_and_placeholder(); ?>" class="img-fluid">
                        </div>
                    </div>
